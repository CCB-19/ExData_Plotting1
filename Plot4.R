...
plot(data$Voltage~data$hour, type="l", ylab="Voltage", xlab="datetime")

plot(data$Sub_metering_1~data$hour, type="l", ylab="Energy sub metering", xlab="")
...
plot(data$Global_reactive_power~data$hour, type="l", ylab="Global_reactive_power", xlab="datetime")